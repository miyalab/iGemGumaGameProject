...
def MapLoad(_map: int):
    ...
    if _map == 0:
        ...
        ret.append([54,90144054,90146054,54,54,9000000,9000000,9000000,54,54,29054,54,90144054,90146054,9000000,9000000,9000000,9000000,9045054,111054,113054,9045054,111054,147054,54,111054,113054,9204054])
        ...
        ret.append([9000000,9000000,9000000,9000000,9000000,9000000,9000000,9000000,9000000,9000000,9064036,103036,63036,9000000,9000000,9000000,9000000,9000000,54,9079054,7071054,54,9080054,9209054,54,9076054,9112054,54])
        ...
        ret.append([38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,39,39,38,38,9000027,9000034,9000034,106,9000034,9000027,38,38,9000031,9000031,9000031,9000031,9000031,9000031,9000031,9000031,105,9000031,9000031,9000031,9000031,9000031,9000031,9000031,9000031,38,38,38,38])
...
def MapMain(bg, clk):
    ...
    while True:
        ...
        # 貼り紙 map 0
            ...
            idef.MessageInit()
            idef.MessageSet("「じっけんきぐ　は　たいせつに　あつかおう」");
